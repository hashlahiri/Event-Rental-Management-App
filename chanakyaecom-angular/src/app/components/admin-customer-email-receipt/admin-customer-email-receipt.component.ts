...
@Component({
  selector: 'app-admin-customer-email-receipt',
  templateUrl: './admin-customer-email-receipt.component.html',
  styleUrls: ['./admin-customer-email-receipt.component.css']
})
export class AdminCustomerEmailReceiptComponent implements OnInit {
