...
@Component({
  selector: 'app-admin-orders-for-today',
  templateUrl: './admin-orders-for-today.component.html',
  styleUrls: ['./admin-orders-for-today.component.css']
})
export class AdminOrdersForTodayComponent implements OnInit {
